...
strout="EmbedOut_0_20fm-0000000001-0"
echo "Output file string "
echo $strout

strembed0="DST_TRUTH_G4HIT_sHijing_0_12fm_50kHz_bkg_0_12fm-0000000001-0"
strembed1="DST_TRKR_G4HIT_sHijing_0_12fm_50kHz_bkg_0_12fm-0000000001-0"
strembed2="DST_CALO_G4HIT_sHijing_0_12fm_50kHz_bkg_0_12fm-0000000001-0"
echo "Hits files " 
echo $strembed0
echo $strembed1
echo $strembed2
...
do
	...
	echo "======================================================="
  	...
  	(/usr/bin/time -v root -b -q "Fun4All_G4_sPHENIX.C(${num_event},${id_number},"\"${strembed0}\"","\"${strembed1}\"","\"${strembed2}\"","\"G4sPHENIX_${job_name}\"")" && echo $? > exit_code_${id_number}.log ) 2>&1 | tee G4sPHENIX_${job_name}.log | (head; tail -n 100)  &
