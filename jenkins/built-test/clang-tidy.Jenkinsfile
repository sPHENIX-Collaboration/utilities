	...
	stages { 
	    ...
	    {	      
	      steps 
	      {
	        ...
	        recordIssues qualityGates: [[threshold: 200000, type: 'NEW', unstable: true], [threshold: 200000, type: 'NEW_HIGH', unstable: true], [threshold: 200000, type: 'NEW', unstable: false], [threshold: 200000, type: 'NEW_HIGH', unstable: false]], tools: [clangTidy(pattern: 'clang-tidy-result.txt')]
	      }										
	    } // 				stage('sPHENIX-Build')
