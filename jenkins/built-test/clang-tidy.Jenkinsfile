pipeline 
{
    ...
    stage('clang-tidy-analysis')
    {
      ...
      steps 
      {
        ...
        recordIssues qualityGates: [[threshold: 1, type: 'NEW', unstable: true], [threshold: 1, type: 'NEW_HIGH', unstable: true], [threshold: 200, type: 'NEW', unstable: false], [threshold: 1, type: 'NEW_HIGH', unstable: false]], tools: [clangTidy(pattern: 'clang-tidy-result.txt')]
      }										
    } // 				stage('sPHENIX-Build')
