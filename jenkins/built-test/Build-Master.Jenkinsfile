...
//    }
	...
	post {
		always{
				...
				if ("$build_type" == 'clang') {
					recordIssues enabledForFailure: true, failedNewHigh: 1, failedNewNormal: 200, tool: clang(pattern: 'build/${build_type}/rebuild.log')
					...
					recordIssues enabledForFailure: true, failedNewHigh: 1, failedNewNormal: 200, tool: gcc(pattern: 'build/${build_type}/rebuild.log')
				}
        		} // script 
