...
//    }
	...
	post {
		...
		always{
			...
			dir('report')
			{
			  writeFile file: "calo-QA.md", text: "* [![Build Status ](https://web.racf.bnl.gov/jenkins-sphenix/buildStatus/icon?job=${env.JOB_NAME}&build=${env.BUILD_NUMBER})](${env.BUILD_URL})Calorimeter QA: [build is ${currentBuild.currentResult}](${env.BUILD_URL}), [QA report](${env.BUILD_URL}/QA_20Report/) "				
			}
