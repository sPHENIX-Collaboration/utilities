...
//    }
	...
	post {
		...
		always{
			...
			dir('report')
			{
			  writeFile file: "QA-tracking-high-occupancy-qa.md", text: "* [![Build Status ](https://web.racf.bnl.gov/jenkins-sphenix/buildStatus/icon?job=${env.JOB_NAME}&build=${env.BUILD_NUMBER})](${env.BUILD_URL}) Tracking QA at high occupancy: [build is ${currentBuild.currentResult}](${env.BUILD_URL}), [:bar_chart:QA report - Tracking](${env.BUILD_URL}/QA_20Report/) "				
			}
