...
\li Find out <b>inter-dependencies between files</b>. Example is on \ref PHG4Hitv6.C page, you can try clicking to unfold <i>"Include dependency graph"</i> and <i>"files directly or indirectly include this file"</i>.
\li Highlighted <b>source code</b> with crossreferencing. Example click <i>"Go to the source code"</i> in \ref PHG4Hitv6.C.
